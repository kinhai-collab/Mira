				...
				<div className="bg-[#f7f8fa] p-8 rounded-lg w-full max-w-[600px]">
					...
					<div className="flex flex-col gap-4 mb-10">
						...
						<p className="text-[18px] leading-[12px] text-[#272829] font-['Outfit',_sans-serif]">
							...
							<a
								href="/signup"
								className="font-bold underline decoration-solid underline-offset-4"
							>
								Sign up
							</a>
						</p>
					...
					<p className="text-[18px] text-center text-[#96989c] font-['Outfit',_sans-serif] mb-8 cursor-pointer hover:text-[#454547] transition-colors">
